...
#
#   ./build.sh v2026.7.14            # build + smoke-test + convert to .sif
#   ./build.sh v2026.7.14 --push     # also push to docker.io/geodels/gospl-hpc
###############################################################################
set -euo pipefail

usage() {
    echo "Usage: $0 <tag> [--push]    e.g. $0 v2026.7.14 --push" >&2
    exit 1
}
[ "$#" -ge 1 ] || usage
