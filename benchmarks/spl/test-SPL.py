...
import matplotlib
matplotlib.use('Agg')   # non-interactive backend — safe for scripts and HPC
import matplotlib.pyplot as plt
import matplotlib.colors as mcolors
import matplotlib.gridspec as gridspec

# =============================================================================
# SPL Benchmark — Stream Power Law Steady-State Validation
# =============================================================================
# Runs a goSPL forward model and evaluates whether the Stream Power Law (SPL)
# incision is implemented correctly by checking three conditions at steady state:
#
#   [0] Domain    — single drainage basin covers >80% of domain
#   [1] Steady state — erosion rate E converges to uplift rate U  (E/U → 1)
#   [2] Slope-area   — S ∝ A^(-m/n)  recovers the correct m/n ratio
#   [3] Steepness    — ks = S·A^(m/n) = (U/K)^(1/n)  uniform across network
#
...
def loadTopology(model_path):
    ...
    # print(f"Mesh loaded — {len(coords):,} nodes | {len(cells):,} triangles | "
