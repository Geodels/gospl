...
Last reviewed 2026-06-13 against `v2026.6.13` (+ dual-lithology feature on `dev`). Read this at the start of every session. Update it when an invariant here changes. See `REFACTOR_AUDIT.md` for the long-form rationale behind each rule.
